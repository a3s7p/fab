...
define clean/body
	...
	-rm -rf auto $O/root.spec $O/cdroot $O/product.iso $O/log $O/screens lb-build.log config cache $(STAMPS_DIR) turnkey-*-amd64.*
	lb clean
endef
...
.PHONY: all debug redeck help clean $(STAMPED_TARGETS) lint
